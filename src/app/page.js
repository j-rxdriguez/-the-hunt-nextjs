...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navbar with Auth0 Login/Logout */}
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="items-center justify-between w-full flex md:w-auto md:order-1" id="navbar-sticky">
            <ul className="flex flex-row p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-black dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <Link href="/about" className="block py-2 px-3 text-xl text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                  About
                </Link>
              </li>
              <li>
                <Link href="/contact" className="block py-2 px-3 text-xl text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                  Contact
                </Link>
              </li>
            </ul>
      ...
      <section className="flex flex-col items-center justify-center h-screen p-8 sm:p-20" id="landing">
        ...
        <p className="mt-4 text-lg text-center">
          Ready for an adventure? Join The Hunt, a thrilling game where you can win real prize money by solving clues, following hidden maps, and discovering a geocache in the real world. All you need is your wits and a sense of adventure!
        </p>
        <div className="mt-8 flex gap-4">
          <Link href="#about" className="btn btn-neutral">Learn more</Link>
          <Link href="#signup" className="btn btn-soft">Sign Up</Link>
        </div>
      </section>
      ...
      <section id="about" className="flex flex-col items-center justify-center h-screen p-8 sm:p-20 bg-gray-100 dark:bg-gray-800">
        ...
        <p className="mt-4 text-lg text-center max-w-2xl">
          Sign Up & Pay
          To enter, simply sign up and pay a small entry fee. You&aposll receive a unique participant ID to track your progress throughout the game.

          Hints Unleashed
          Once 1,000 players have joined, we&aposll release clues and map snippets on social media that will help guide you to the hidden geocache. These hints are key—solve them to unlock the next stage of the game.
